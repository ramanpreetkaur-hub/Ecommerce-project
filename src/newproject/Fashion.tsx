...
const Fashion = ({categories}) => {
   const [likedProducts, setLikedProducts] = useAtom(likedProductsAtom);
    ...
    const Fashion = categories .find ((category)=>category.name==="Fashion")
  return (
    
    <div>
       
       <section id="Fashion" className="py-16 bg-gray-100">
      <h2 className="text-3xl font-bold text-center">Fashion</h2>
